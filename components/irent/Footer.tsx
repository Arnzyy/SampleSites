          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-neutral-400 hover:bg-rose-500 hover:text-white transition-all duration-300"
              >
