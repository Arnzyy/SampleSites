...
const services = [
  {
    ...
    description:
      "We find reliable, vetted tenants using rigorous background checks, credit scoring, and reference verification. No more problem tenants.",
  ...
  },
  {
    ...
    description:
      "From drafting legally compliant tenancy agreements to handling renewals and terminations, we manage all the paperwork for you.",
  ...
  },
  {
    ...
    description:
      "24/7 emergency response with our network of trusted contractors. We handle everything from minor fixes to major renovations.",
  ...
  },
  {
    ...
    description:
      "Detailed monthly statements and annual reports. Full transparency on income, expenses, and property performance.",
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
          ...
          >
            Comprehensive property management that covers every aspect of your
            HMO investment. We handle the work, you enjoy the returns.
          </p>
        </div>
