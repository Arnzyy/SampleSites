          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative h-56 overflow-hidden">
                ...
                {/* Icon */}
                <div className={`absolute top-4 left-4 w-12 h-12 rounded-xl bg-[#E91E8C] flex items-center justify-center transition-all duration-500 ${
                  hoveredIndex === index ? "scale-110 bg-[#38BDF8]" : ""
                }`}>
