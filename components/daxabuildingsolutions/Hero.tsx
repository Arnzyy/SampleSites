      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 lg:py-40">
        <div className="max-w-4xl">
          ...
          >
            <a
              href="#contact"
              className="group relative px-8 py-4 bg-gradient-to-r from-[#E91E8C] to-[#38BDF8] text-white font-semibold rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-[#E91E8C]/25 hover:-translate-y-1 flex items-center justify-center gap-2"
            >
            ...
            <a
              href="#services"
              className="px-8 py-4 bg-white/5 border border-white/20 text-white font-semibold rounded-2xl hover:bg-white/10 transition-all duration-300 flex items-center justify-center gap-2 backdrop-blur-sm"
            >
